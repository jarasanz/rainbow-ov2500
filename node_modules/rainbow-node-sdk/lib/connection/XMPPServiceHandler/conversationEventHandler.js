...
let ConversationEventHandler = class ConversationEventHandler extends GenericHandler {
    constructor(xmppService, conversationService, fileStorageService, fileServerService) {
        ...
        this.onConversationManagementMessageReceived = (node) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (node.attrs.xmlns === "jabber:iq:configuration") {
                    ...
                    if (conversation) {
                        ...
                        if (action === "create") {
                            ...
                            if (type === "user") {
                                conversationGetter = yield this.conversationService.getOrCreateOneToOneConversation(convId);
                            }
                            else {
                                let bubbleId = convId;
                                ...
                                conversationGetter = yield this.conversationService.getBubbleConversation(bubbleId, peerId, lastModification, lastMessageText, missedIMCounter, null, muted, new Date(), lastMessageSender);
                            }
                            if (!conversationGetter) {
                                return;
                            }
                            yield conversationGetter.then(function (conv) {
